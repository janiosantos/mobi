...
class RatingController extends Controller
{
     ...
     * @return JsonResponse
     */
    public function rateDriver(RateRideRequest $request, int $rideId): JsonResponse
    {
        $user = $request->user();
        ...
        $driver = $ride->driver;
        $avgRating = Rating::where('rated_id', $driver->id)->avg('stars');
        $totalRatings = Rating::where('rated_id', $driver->id)->count();
    ...
    /**
     * Get ratings given by passenger
     *
